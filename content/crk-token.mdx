...
> **Legitimate users**: Consider apply this to contact form, newsletter. 
If you're using external third like payment. It should be consider to exclude the domain
